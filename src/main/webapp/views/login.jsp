...
<%--        điền sẵn--%>
    ...
    <div class="container" style="background-color:#f1f1f1; padding: 10px;">
        <button type="button" class="cancelbtn" style="margin-right: 20px;">Cancel</button>

        <span class="psw" style="margin-right: 20px;">
        <a href="${pageContext.request.contextPath }/forgetpassword">Forgot password?</a>
    </span>

        <a class="psw btn btn-primary"  href="${pageContext.request.contextPath }/register">Register</a>
    </div>
